...
def ParseWootMessage(message, path, i):
    ...
    for part in message.walk():
        ...
        print("Scanning for [Monkey-Chat-DD-Banner] in email body...")
        q = txt.find('Monkey-Chat-DD-Banner')
        if q == -1:
            print("Scanning for [Today's monkey chat] in email body...")
            q = txt.find("Today's monkey chat")
